...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Sprint findByIdsprint(@PathParam("idsprint") Long idsprint)">
    @GET
    @Path("{idsprint}")
    public Sprint findByIdsprint(@Parameter(description = "El idsprint", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("idsprint") Long idsprint);
// </editor-fold>

//    // <editor-fold defaultstate="collapsed" desc="List<Sprint> findBySprint(@Parameter(description = "El sprint", required = true, example = "1", schema = @Schema(type = SchemaType.STRING)) @QueryParam("sprint") final String sprint)">
    @GET
    @Path("sprint")
    public List<Sprint> findBySprint(@Parameter(description = "El sprint", required = true, example = "1", schema = @Schema(type = SchemaType.STRING)) @QueryParam("sprint") final String sprint);
//// </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Response save">
    @POST

    public Response save(@RequestBody(description = "Crea un nuevo sprint.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Sprint.class))) Sprint sprint);
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Response update">

    @PUT

    public Response update(@RequestBody(description = "Crea un nuevo sprint.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Sprint.class))) Sprint sprint);
...
// </editor-fold>
    ...
    public Response delete(@Parameter(description = "El elemento idsprint", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("idsprint") Long idsprint);
    // </editor-fold>
