 ...
 */
@DocumentEmbeddable
public class PresenciaEpitales {
    ...
    public PresenciaEpitales() {
    }

    public PresenciaEpitales(Boolean zero, Boolean one, Boolean twofour, Boolean fivetwentynine, Boolean greaterthan30, Boolean activo, Double valor) {
        this.zero = zero;
        this.one = one;
    ...
    public boolean equals(Object obj) {
        ...
        final PresenciaEpitales other = (PresenciaEpitales) obj;
