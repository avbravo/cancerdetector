...
@Named
@RequestScoped
public class JmoordbCoreMediaManager1 implements Serializable {
// <editor-fold defaultstate="collapsed" desc="field">
    ...
    public void init() {
        try {
            ...
            String fileDownloadPath = (String) JmoordbCoreMediaContext.get("pathOfFile1");
            String nameFileDownloadPath = (String) JmoordbCoreMediaContext.get("nameOfFile1");
