...
@ViewScoped
@Data
public class BacklogFaces implements Serializable, JmoordbCoreXHTMLUtil, TableroFacesServices, FacesWebSocket, FacesServices {
...
// </editor-fold>
    ...
    private Boolean loadTarjetaBacklog() {
...
//            Document sortTarjeta = new Document("idtarjeta", -1).append("prioridad", 1);
            ...
            Bson filter = and(filter0, eq("backlog", Boolean.TRUE), eq("idsprint", 0L), eq("active", Boolean.TRUE));
            if (isPropietario) {
            } else {
        ...
        try {
            ...
            if (!tarjetaServices.update(tarjeta)) {
                ...
                MessageWebSocket messageWebSocket = new MessageWebSocket.Builder()
                        ...
                        .key("tarjeta")
                        .value(tarjeta.getIdtarjeta() != null ? tarjeta.getIdtarjeta().toString() : "")
                        .message("Tarjeta pasada al Tablero desde reserva")
                        .iduser(userLogged.getIduser())
                        .date(JmoordbCoreDateUtil.fechaHoraActual())
                        .build();
