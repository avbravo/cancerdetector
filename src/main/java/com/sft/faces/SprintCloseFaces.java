...
@ViewScoped
@Data
public class SprintCloseFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices, FacesServices {
    ...
    public void agregarRowSprint() {
        try {
            ...
            if (sprintList == null || sprintList.isEmpty()) {
                ...
                Date fechaInicial = JmoordbCoreDateUtil.sumarDiaaFecha(sprintList.get(0).getFechafinal(), 3);
                Date fechaFinal = JmoordbCoreDateUtil.sumarDiaaFecha(sprintList.get(0).getFechafinal(), 9);

                sprintSelected.setFechainicial(JmoordbCoreDateUtil.insertHoursMinutesSecondsToDate(fechaInicial, 8, 0, 0));
                sprintSelected.setFechafinal(JmoordbCoreDateUtil.insertHoursMinutesSecondsToDate(fechaFinal, 23, 59, 0));
            }
...
//                            textoFiltro, FontFactory.getFont("arial", 10, Font.BOLD), Element.ALIGN_CENTER));
            ...
            table.setTotalWidth(new float[]{60, 70, 120, 60, 60, 60});
