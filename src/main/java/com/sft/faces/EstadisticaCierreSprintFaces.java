...
@ViewScoped
@Data
public class EstadisticaCierreSprintFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices , FacesServices{
...
/**
 * rotate se usa para cambiar la horientacion del reporte a vertical u horizontal
 */
        ...
        try {
            ...
            document.add(
                    ReportUtils.paragraph(
                            rf.fromMessage("print.titleestadisticacierresprintporproyecto"), FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
...
//                            textoFiltro, FontFactory.getFont("arial", 10, Font.BOLD), Element.ALIGN_CENTER));
            ...
            // Aqui indicamos el tamaño de cada columna
            table.setTotalWidth(new float[]{60, 70, 60, 60, 60, 60,60,60});
            ...
            table.addCell(
                    ReportUtils.PdfCell(
                            rf.fromMessage("print.print.porcentajesimbol"), FontFactory.getFont("arial", 11, Font.BOLD), Element.ALIGN_CENTER));
            ...
            for (int i = 1; i <= totalPage; i++) {
                ...
                if (list == null || list.isEmpty()) {
                    ...
                    list.forEach(c -> {
                        ...
                        table.addCell(
                                ReportUtils.PdfCell(c.getEstadisticaCierre().getAvance().toString(), FontFactory.getFont("arial", 10, Font.NORMAL)));
