...
@ViewScoped
@Data
public class PapeleraReciclajeFaces implements Serializable, JmoordbCoreXHTMLUtil, TableroFacesServices, FacesWebSocket, FacesServices {
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Boolean loadTarjetaPapeleraReciclaje()">
    private Boolean loadTarjetaPapeleraReciclaje() {
...
//            Document sortTarjeta = new Document("idtarjeta", -1).append("prioridad", 1);
            ...
            Bson filter = and(filter0, eq("active", Boolean.FALSE));
            if (isPropietario) {
            } else {
        ...
        try {
            ...
            if (!sprintList.isEmpty()) {
                ...
                if (sprintList.size() > 1) {
                    ...
                    sprintSelected = sprintList.get(0);
    ...
    public void pasarAlTablero(Tarjeta tarjeta) {
        try {
            ...
            ActionHistory actionHistory = new ActionHistory.Builder()
                    .iduser(userLogged.getIduser())
                    .fecha(JmoordbCoreDateUtil.fechaHoraActual())
                    .evento("Pasar al sprint desde papelera")
                    .clase(FacesUtil.nameOfClass())
                    .metodo(FacesUtil.nameOfMethod())
                    .build();
            ...
            if (!tarjetaServices.update(tarjeta)) {
                ...
                MessageWebSocket messageWebSocket = new MessageWebSocket.Builder()
                        ...
                        .message("Pasar al sprint desde papelera")
                        .iduser(userLogged.getIduser())
...
// </editor-fold>
    ...
    public String prepareNew() {
        try {
            ...
            tarjetaSelected.setFechainicial(JmoordbCoreDateUtil.fechaHoraActual());
            tarjetaSelected.setFechafinal(JmoordbCoreDateUtil.fechaHoraActual());
...
// </editor-fold>
    ...
    private void loadTipotarjetaByProyecto(Proyecto proyecto) {
        try {
            List<Tipotarjeta> result = tipotarjetaServices.loadTipotarjetaByProyecto(proyecto);
...
//            if (!tarjetaServices.equalsExcludedNameOfTarjeta(tarjeta, tarjetaInlineSelected)) {
//            
//                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.otrousuarioactualizotarjetasincronizeeltablero"));
