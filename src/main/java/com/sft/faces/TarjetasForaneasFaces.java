...
@ViewScoped
@Data
public class TarjetasForaneasFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices, FacesServices {
        ...
        try {
            ...
            if (metodoFiltrarTarjetas.equals("findByProyectoAndSprint()")) {
                ...
                if (metodoFiltrarTarjetas.equals("findByProyecto()")) {
                    ...
                    document.add(
                            ReportUtils.paragraph(
                                    rf.fromMessage("print.titlestarjetasdelproyecto"), FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
