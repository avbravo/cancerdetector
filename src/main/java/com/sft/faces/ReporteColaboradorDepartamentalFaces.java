...
@ViewScoped
@Data
public class ReporteColaboradorDepartamentalFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices, FacesWebSocket , FacesServices{
...
@Inject
    ...
    private CentralView centralViewSelected = new CentralView();
    ...
    public UserView getUserViewSelected() {
        if (userViewSelected == null) {
            userViewSelected = new UserView();
        }
        return userViewSelected;
    }
    ...
    public CentralView getCentralViewSelected() {
        if (centralViewSelected == null) {
            centralViewSelected = new CentralView();
        }
        return centralViewSelected;
    }
    ...
    public void init() {
        try {
            ...
            if (userViewList == null || userViewList.isEmpty()) {
                ...
                userViewSelected = userViewList.get(0);
            }
...
//            }
            filter = and(filter,
                    eq("departament.iddepartament", departamentViewSelected.getIddepartament()),
                    eq("proyectoMiembro.user.iduser", userViewSelected.getIduser())
            );

            Document sort = new Document("idproyecto", -1);
            String title = departamentViewSelected.getDepartament() + " " + userViewSelected.getName();
            paginator
...
// </editor-fold>
    ...
    public String goTablero(Proyecto proyecto, Boolean isProyectoForaneo, Boolean isEditable) {
        try {
            ...
            JmoordbCoreContext.put("DashboardFaces.callerLevel0", "reportecolaboradordepartamental");
...
// </editor-fold>
    ...
    public String goTarjetas(Proyecto proyecto) {
        try {
            ...
            JmoordbCoreContext.put("DashboardFaces.callerLevel0", "reportecolaboradordepartamental");
            JmoordbCoreContext.put("DashboardFaces.callerLevel1", "reportecolaboradordepartamental");
...
// </editor-fold>
    ...
    public void autocompleteSelectedEvent(SelectEvent<CentralView> event) {
        try {
