...
@ViewScoped
@Data
public class TipoTarjetaFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, TipoTarjetaFacesServices, FacesServices {
// <editor-fold defaultstate="collapsed" desc="ConverterServices">
 ...
 @Inject
    ...
    private Tipotarjeta tipotarjetaSelectedAutocomplete = new Tipotarjeta();
    private Tipotarjeta tipotarjetaDB = new Tipotarjeta();
    private Proyecto proyectoSelected = new Proyecto();

    private List<ResponsiveOption> responsiveOptions;

    private List<Tipotarjeta> tipotarjetaList = new ArrayList<>();
    private List<GrupoTipoTarjeta> grupoTipoTarjetaList = new ArrayList<>();
    private List<Tarjeta> tarjetaList = new ArrayList<>();

    private Boolean haveTipotarjetaOpen = Boolean.FALSE;
    ...
    public Tipotarjeta getTipotarjetaSelected() {
        if (tipotarjetaSelected == null) {
    ...
    private LazyDataModel<Tipotarjeta> tipotarjetaLazyDataModel;
// </editor-fold>
...
// </editor-fold>
    ...
    public void init() {
        try {
            haveTipotarjetaOpen = Boolean.FALSE;
            message = "";
            ...
            tipotarjetaSelectedAutocomplete = new Tipotarjeta();
            ...
            this.tipotarjetaLazyDataModel = new LazyDataModel<Tipotarjeta>() {
                @Override
                public List<Tipotarjeta> load(int offset, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filterBy) {

                    switch (paginator.getName()) {
                        case "findAll":

                            totalRecords = tipotarjetaServices.count(paginator.getFilter(),
...
//
                    ...
                    switch ((paginator.getName())) {
                        case "findAll":
                            ...
                            result = tipotarjetaServices.lookup(paginator.getFilter(),
                ...
                @Override
                public String getRowKey(Tipotarjeta object) {
                    if (object == null || object.getIdtipotarjeta() == null) {
                        return "";
                    }
                    return object.getIdtipotarjeta().toString();
                }

                @Override
                public Tipotarjeta getRowData(String rowKey) {
                    for (Tipotarjeta t : tipotarjetaList) {
                        if (t != null) {
                            if (t.getIdtipotarjeta().equals(rowKey)) {
                                return t;
                            }
                        }
                    }
...
grupoTipoTarjetaConverterServices.destroyed();
    ...
    // <editor-fold defaultstate="collapsed" desc="void loadGrupoTipotarjeta()">
    private void loadGrupoTipotarjeta() {
        try {
            ...
            grupoTipoTarjetaList = grupoTipoTarjetaServices.lookup(
                    filter,
                    sort,
                    page, size);
               grupoTipoTarjetaConverterServices.add(grupoTipoTarjetaList);
        ...
        try {
            ...
            paginator
                    = new Paginator.Builder()
                            ...
                            .filter(filter)
                            .sort(sort)
                            .sorted(new Sorted(new Document("idtipotarjeta", -1)))
                            .title("Todos")
                            .name("findAll")
                            .build();
...
// </editor-fold>
    ...
    public String findByIdTipotarjeta() {
        try {

            Bson filter0 = or(eq("active", Boolean.FALSE),
                    eq("active", Boolean.TRUE)
            );
            Bson filter = and(filter0, eq("idtipotarjeta", tipotarjetaSelectedAutocomplete.getIdtipotarjeta()));
            Document sort = new Document("tipotarjeta", 1);
            ...
            paginator
                    = new Paginator.Builder()
                            ...
                            .filter(filter)
                            .sort(sort)
                            .sorted(new Sorted(new Document("tipotarjeta", -1)))
                            .title("Todos")
                            .name("findAll")
                            .build();
...
// <editor-fold defaultstate="collapsed" desc="String saveToMediaContext(String pathOfFile, String... nameOfFile)">
    ...
    // <editor-fold defaultstate="collapsed" desc="save(Tipotarjeta tipotarjeta)">
    public void save(Tipotarjeta tipotarjeta) {
        try {

            tipotarjetaSelected = tipotarjeta;
            tipotarjetaSelected.setActive(Boolean.TRUE);
            tipotarjetaSelected.setTipotarjeta(tipotarjetaSelected.getTipotarjeta().trim());
            if (tipotarjetaSelected.getGrupoTipoTarjeta() == null || tipotarjetaSelected.getGrupoTipoTarjeta().getIdgrupotipotarjeta() == null) {
                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.seleccionegrupotipotarjeta"));
                return;
            }

            if (tipotarjeta.getTipotarjeta() == null || tipotarjeta.getTipotarjeta().equals("")) {
                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.ingresetipotarjeta"));
                return;
            }

            if (tipotarjetaServices.existsTipotarjeta(tipotarjetaSelected)) {
            ...
            tipotarjetaSelected.setActionHistory(actionHistoryList);

            Optional<Tipotarjeta> tipotarjetaOptional = tipotarjetaServices.save(tipotarjetaSelected);
            if (!tipotarjetaOptional.isPresent()) {
                FacesUtil.warningDialog(rf.fromCore("warning.save"), rf.fromCore("warning.save"));
            } else {
                tipotarjetaSelected = tipotarjetaOptional.get();
                JmoordbCoreContext.put("TipotarjetaFaces.tipotarjetaSelected", tipotarjetaSelected);
                ...
                closeOverlayPanel("PF('overlayPanelTipotarjeta').hide()");
                refresh();
            }
...
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="edit(Tipotarjeta tipotarjeta)">

    public void edit(Tipotarjeta tipotarjeta) {
        try {
            Tipotarjeta tipotarjetaDBNow = tipotarjetaServices.findByIdtipotarjeta(tipotarjeta.getIdtipotarjeta()).get();
            if (!tipotarjetaDBNow.equals(tipotarjetaDB)) {
             ...
             *
             */
            if (tipotarjetaServices.existsTipotarjetaWithDiferentId(tipotarjetaSelected)) {
                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.exitsotherdocumentwiththistipoandgrupo"));
                return;
            ...
            ActionHistory actionHistory = new ActionHistory.Builder()
                    ...
                    .build();
            List<ActionHistory> actionHistoryList = new ArrayList<>();
             actionHistoryList.addAll(tipotarjeta.getActionHistory());
            actionHistoryList.add(actionHistory);

            tipotarjetaSelected.setActionHistory(actionHistoryList);

            Boolean isUpdate = tipotarjetaServices.update(tipotarjetaSelected);
            if (!isUpdate) {
                 ...
                 * Actualiza las tarjetas
                 */
                //  tipotarjetaList.add(tipotarjetaSelected);
                //  PrimeFaces.current().ajax().update("dataTable");
                closeOverlayPanel("PF('overlayPanelTipoTarjeta').hide()");
                //refresh();
            }
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="void agregarRowTipotarjeta()">
    public void agregarRowTipotarjeta() {
        try {
            ...
            tituloDialogo = rf.fromMessage("dialog.tipotarjetaagregar");
            PrimeFaces.current().ajax().update("outputPanelTipotarjeta");
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="String prepareTipotarjeta(Tipotarjeta tipotarjeta)">
    public String prepareTipotarjeta(Tipotarjeta tipotarjeta) {
        try {
            tipotarjetaSelected = new Tipotarjeta();
            tipotarjetaSelected.setActive(Boolean.TRUE);
            showDialogContent = Boolean.TRUE;
            tipotarjetaSelected = validarSiCambioTipotarjeta(tipotarjeta);
            isOverlayPanelOpen = Boolean.TRUE;
            isButtonSavePressed = Boolean.TRUE;
            buttonNewPressed = Boolean.FALSE;
            tituloDialogo = rf.fromMessage("dialog.tipotarjetaeditar");
        } catch (Exception e) {
            FacesUtil.errorMessage(FacesUtil.nameOfClassAndMethod() + " " + e.getLocalizedMessage());
        }
        return "";
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Tipotarjeta validarSiCambioTipotarjeta(Tipotarjeta tipotarjeta)">
    private Tipotarjeta validarSiCambioTipotarjeta(Tipotarjeta tipotarjeta) {
        Tipotarjeta result = new Tipotarjeta();
        try {
            message = "";
            fueCambiadoPorOtroUsuario = Boolean.FALSE;
            this.tipotarjetaDB = tipotarjetaServices.findByIdtipotarjeta(tipotarjeta.getIdtipotarjeta()).get();
            if (tipotarjetaDB.equals(tipotarjeta)) {
                result = tipotarjeta;
            } else {
                fueCambiadoPorOtroUsuario = Boolean.TRUE;
                message = rf.fromMessage("warning.otrousuarioactualizotipotarjetaincronizeeltablero");
                result = tipotarjetaDB;
                showDialogContent = Boolean.FALSE;
        ...
        try {
            ...
            document.add(
                    ReportUtils.paragraph(
                            rf.fromMessage("print.titletipotarjeta"), FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
...
//                            textoFiltro, FontFactory.getFont("arial", 10, Font.BOLD), Element.ALIGN_CENTER));
            ...
            table.addCell(
                    ReportUtils.PdfCell(
                            rf.fromMessage("print.idtipotarjeta"), FontFactory.getFont("arial", 11, Font.BOLD), Element.ALIGN_CENTER));

            table.addCell(
                    ReportUtils.PdfCell(
                            rf.fromMessage("print.tipotarjeta"), FontFactory.getFont("arial", 11, Font.BOLD), Element.ALIGN_CENTER));
...
//            
            ...
            for (int i = 1; i <= totalPage; i++) {
                ...
                List<Tipotarjeta> list = tipotarjetaServices.lookup(paginator.getFilter(),
                ...
                if (list == null || list.isEmpty()) {
                    ...
                    list.forEach(c -> {
                        ...
                        table.addCell(
                                ReportUtils.PdfCell(
                                        c.getIdtipotarjeta().toString(), FontFactory.getFont("arial", 10, Font.NORMAL)));

                        table.addCell(
                                ReportUtils.PdfCell(
                                        c.getTipotarjeta(), FontFactory.getFont("arial", 9, Font.NORMAL)));

                        if (c.getGrupoTipoTarjeta() == null || c.getGrupoTipoTarjeta().getGrupoTipoTarjeta() == null) {
                            table.addCell(
                                    ReportUtils.PdfCell(
                            ...
                            table.addCell(
                                    ReportUtils.PdfCell(
                                            c.getGrupoTipoTarjeta().getGrupoTipoTarjeta(), FontFactory.getFont("arial", 9, Font.NORMAL)));
                        }
...
// </editor-fold>
    ...
    public void autocompleteSelectedEvent(SelectEvent<Tipotarjeta> event) {
        try {
