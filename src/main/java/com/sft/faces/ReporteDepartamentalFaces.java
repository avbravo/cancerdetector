...
@ViewScoped
@Data
public class ReporteDepartamentalFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices, FacesWebSocket , FacesServices{
...
//            }
            filter = and(filter, eq("departament.iddepartament", departamentViewSelected.getIddepartament()));
            Document sort = new Document("idproyecto", -1);
            String title = departamentViewSelected.getDepartament();
            paginator
...
// </editor-fold>
    ...
    public String goTablero(Proyecto proyecto, Boolean isProyectoForaneo, Boolean isEditable) {
        try {
            ...
            JmoordbCoreContext.put("DashboardFaces.callerLevel0", "reportedepartamental");
...
// </editor-fold>
    ...
    public String goTarjetas(Proyecto proyecto) {
        try {
            ...
            JmoordbCoreContext.put("DashboardFaces.callerLevel0", "reportedepartamental");
            JmoordbCoreContext.put("DashboardFaces.callerLevel1", "reportedepartamental");
