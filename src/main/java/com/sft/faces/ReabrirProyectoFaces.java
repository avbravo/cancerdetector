...
@ViewScoped
@Data
public class ReabrirProyectoFaces implements Serializable, JmoordbCoreXHTMLUtil, IPaginator, SprintFacesServices, FacesWebSocket, FacesServices {
        ...
        try {
            ...
            document.add(
                    ReportUtils.paragraph(
                            rf.fromMessage("print.titlesproyectosarchivados"), FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
