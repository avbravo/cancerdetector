...
@ViewScoped
@Data
public class TimeLineProyectosFaces implements Serializable, JmoordbCoreXHTMLUtil , FacesServices{
        ...
        try {
           ...
           List<ProyectoSprintOpen>  proyectoSprintOpenPublicoList = proyectoServices.cargarProyectosPublicosNoAsignadosConSprintAbierto(userLogged);
            ...
            message = "";
                 ...
                 */
                timelineList = timelineServices.findByProyectoAndActive(proyectoList, Boolean.TRUE);
